    ...
    <>
        <div className="">
          ...
          <div
            ...
            bg-slate-50 md:top-28  md:right-10 lg:top-40 lg:right-16  p-4 rounded-md gap-2 w-1/3
            dark:bg-slate-800"
          >
            ...
            <a
              href="#ContactMe"
              className="text-left md:text-sm lg:text-base border-orange-600 border-2 rounded-full w-fit p-2 dark:text-white"
            >
              Hire me
            </a>
          </div>
